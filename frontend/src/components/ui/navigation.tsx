...
import { Home, MessageCircle, BarChart3, BookOpen, NotebookPen, Moon, Sun, Monitor, LogOut } from "lucide-react";
  ...
  return (
    <div className="fixed bottom-4 inset-x-0 z-50">
      <div className="mx-auto w-full max-w-7xl px-4">
        <div className="bg-card/90 backdrop-blur-md border border-border/20 rounded-3xl shadow-lg w-full">
