...
8. **Mention latest mood only once** — retrieve the top-most mood log at the start, ask for confirmation once, then continue without repeating it unless the user reports a mood change.
